...
$mw=$_POST['moleculrweight'];   

 
    
 
    $query="SELECT * FROM `adminp` WHERE `productname`='$productname' ";
    ...
    if($num_rows>0)
        ...
        $query = "INSERT INTO adminp( productname,CASnumber,CATnumber,molecularformula,molecularweight) VALUES ('$productname','$CASnumber','$CATnumber','$mf','$mw') ";
   echo "product-Insertion-successful";
$data=mysqli_query($con,$query);

if($data)
    header("Location:products.php?registration==success");
    else
      ...
      <div class="container">
        ...
        <div class="collapse navbar-collapse" id="navbarResponsive">
          <ul class="navbar-nav text-uppercase ml-auto">
            ...
            <li class="nav-item">
              <a class="nav-link js-scroll-trigger" href="admin.php">products</a>
            </li>
            <li class="nav-item">
                ...
                <div class="row">
                    ...
                    <div class="row">
                            ...
                            <form action="admin.php" method="POST">
                                ...
                                <input id="ember361" class="form-control" placeholder="CAS number" name="CAS number" type="text" required>


                                <input id="ember360" class="form-control" placeholder="CAT number" name="CAT number" type="text"  required>
