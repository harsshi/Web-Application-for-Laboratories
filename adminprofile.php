...
if(count($_POST)>0) 
{
	$sql = "SELECT * FROM adm where username='" . $_GET["username"] . "' AND password='" . $_GET["password"] . "'";
      ...
      <div class="container">
        <div class="row">
          <div class="col-lg-12 text-center">
            ...
            <?php
               include 'db.php';
               $sql ="SELECT * from adm where email_id ='$usermail' ";
               $result = mysqli_query($conn,$sql);
            ...
            <display>
                ...
                <h6>  password:<?php echo $row['phonenumber'] ?>
                  
                </h6>
                <h6> <placeholder> name:<?php echo $row['name'] ?> </placeholder></h6>
                <h6>mail_id:<?php echo $row['mailid'] ?>
