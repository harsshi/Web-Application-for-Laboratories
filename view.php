...
<?php
   $m = $_POST['open'];
   $sq = "SELECT * from adminproducts where id = '$m' ";
   $t   = mysqli_query($conn,$sq);
   while($c = mysqli_fetch_array($t))
   {
...
<input type="hidden" value="products" id="pageid" /><div class="col-md-12 brick" style="width:100% !important;">
    <h3 style="margin-bottom:30px;"><?php echo $c['productname'] ?> </h3>
    <div class="col-md-5"> 
  
  </div>
    <div class="col-md-7"> <br><br><br>
  <p> <strong> CAS No  </strong> : <?php echo $c['cas'] ?> <br>
              <strong>  Molecular Formula : </strong> <?php echo $c['molecularformula'] ?> <br>
                <strong> Molecular Weight </strong>   <?php echo $c['molecularweight'] ?><br>
                <strong> CAT No : </strong>   <?php echo $c['cat'] ?>
                </p>
                <a href="#" class="btn btn-primary modal-open" data-toggle="modal" data-target=".bs-example-modal-lg">   RFQ </a>
  
   </div>
   <strong> Synonyms : </strong>   <?php echo $c['productname'] ?>
  ...
  <div class="modal-dialog" style="min-width:80%;"  role="document">
    ...
    <h3  style="margin-bottom:10px;" ><?php echo $c['productname'] ?> </h3>
    <div class="col-md-5"> 
  <img style="max-height:150px;" src="https://drive.google.com/uc?id=0B8-NsDn0E-3aZXg4ZnZqWXRyMkE">
  </div>
    <div class="col-md-7"> 
  <p> <strong> CAS No  </strong> : <?php echo $c['cat'] ?><br>
              <strong>  Molecular Formula : </strong>  <?php echo $c['molecularformula'] ?><br>
                <strong> Molecular Weight : </strong>  <?php echo $c['molecularweight'] ?><br>
                <strong> CAT No : </strong>   <?php echo $c['cat'] ?></p> </div>
   <div class="col-md-12">
